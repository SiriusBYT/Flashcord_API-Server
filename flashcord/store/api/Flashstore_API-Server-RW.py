...
async def Application_Programming_Interface(Client,Client_Address,isWebSocket):
    ...
    async def ReceiveData():
        try:
            ...
            WriteLog(f"TIMED OUT: {Client_Address}.", False)
    ...
    async def CheckVersion():
        ...
        try: Client_Version = float(Client_Data)
            ...
            WriteLog(f'API Version Check // ERROR: {Client_Address} Invalid "{Client_Data}" API Version!', False)
            await Code_Client_Invalid_Version(); return
